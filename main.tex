...
\indent Ta wersja pracy zawiera \hyperref[sec:dodatek]{użyteczny Dodatek~}\ref{sec:dod:dodatek} oraz przypisy. Wyjaśniono w~nich różnice między wersją pierwotną z~2017 roku a~obecną.
