...
\date{2017\footnote{Dokument skompilowano z klasą {\tt SGGW-thesis} w wersji \SGGWthesisVersion. Różni się ona od opisanej tutaj, lecz różnice w~korzystaniu z~niej są małe -- proszę przeczytać plik {\tt readme}. Aktualną wersję klasy można pobrać ze strony \hspace{0.2em}\url{https://github.com/lchmiel/SGGW-Thesis-LaTeX}\hspace{0.2em} lub ze strony \hspace{0.2em}\url{http://stud.lchmiel.pl} $\rightarrow$
