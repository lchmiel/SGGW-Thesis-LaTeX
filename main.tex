...
% Po usunięciu Dodatku w Państwa poniżą sekcję można usunąć,
% chyba, że korzystając ze wzorców w Dodatku, używamy niektórych pakietów i ustawień.
\SHOWREMARKStrue
\usepackage{xcolor}
...
% Ustawienia kolorów w PDF należy usunąć, bo kolory nie są korzystne w druku.
